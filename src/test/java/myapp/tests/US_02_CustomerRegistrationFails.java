...
import myapp.pages.AlloverCommerce_SignUpPage;
...
public class US_02_CustomerRegistrationFails {
...
//          and still on the registration page)
    ...
    AlloverCommerce_SignUpPage registrationPage = new AlloverCommerce_SignUpPage();
